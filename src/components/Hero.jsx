  ...
  return (
    <section className='relative w-full mx-auto h-screen'>
      ...
      <h1 className={`${styles.heroHeadText} `}>
        Hi, I am <span className='text-[#915eff]'>Abdul</span>
      </h1>
      <p className={`${styles.heroSubText} text-white-100 mt-2 `}> I develop 3D visuals, UI/UX, <br className='sm:block hidden' /> Web Applications and Mobile Applications</p>
      </div>
      </div>
